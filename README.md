...
9. и 10. **Программа-реестр домашних животных** и **Счетчик животных**

В соответствии с описанной архитектурой приложения в предыдущем пункте было написано приложение, имитирующее реестр домашних животных.
В приложении реализован пользовательский интерфейс с выбором различных опций. Опции выбираются с помощью ввода цифры, соответствующей опции.

Исходный код программы расположен в каталоге [src](src) репозитория.

В первую очередь программа предлагает добавить в реестр новых питомцев.

![Добавление питомца](img/screen9-1.jpg)

Для примера добавлю восемь питомцев и попытаюсь показать их всех в виде списка.

![Добавление питомца](img/screen9-2.jpg)

Животные добавлены. Можно проводить различные манипуляции.

1) Добавление команд.
![Добавление питомца](img/screen9-3.jpg)
2) Отображение списка с добавленными командами.
![Отображение списка](img/screen9-4.jpg)
3) Отображение общего количества животных в реестре.
![Отображение общего количества](img/screen9-5.jpg)
4) Показать команды определенного питомца (выбор питомца по ID).
![Показать команды](img/screen9-6.jpg)
5) Удалить питомца по ID и показать изменившийся общий список.
![Удалить питомца](img/screen9-7.jpg)
6) Отсортировать питомцев по дате рождения.
![Отсортировать питомцев](img/screen9-8.jpg)
